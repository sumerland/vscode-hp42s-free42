...
export class Encoder42 {
    ...
    if (rawLine.workCode !== undefined) {
      ...
      if (progErrorText === undefined) {
        if (rawLine.tokenLength === 1) {
          //#region 1 Token
          if (
            rawLine.params.str !== undefined &&
            rawLine.workCode.match(/^(⊢|)`str`/)
          ) {
            // is it a string ...
            rawLine.raw = Encoder42.insertStringInRaw(
              rawLine.raw,
              rawLine.params.str
            );
          } else if (
            rawLine.params.num !== undefined &&
            rawLine.workCode.match(/^`num`/)
          ) {
  ...
  private static getLanguageIdFromCode(
    rawLine: RawLine,
    languageId: string
  ): string {
    let languageIdFromCode: string;
    if (
      ...
      // ACCEL|ADATE|ANUM|ATIME24|ATIME|BRESET|BSIGNED|BWRAP|CLK12|CLK24|DATE|DATE+|DDAYS|DMY|DOW|FMA|FUNC|GETKEY1|HEADING|LOCAT|LSTO .+|MDY|MVARCAT|NOP|PGMMENU|RCLFLAG|RTNERR|RTNNO|RTNYES|STOFLAG|TIME|X<>F|YMD
      rawLine.token &&
      rawLine.token.match(
   ...
   */
  private static insertStringInRaw(
    raw?: string,
    str?: string
  ): string | undefined {
    if (raw !== undefined) {
  ...
  private static insertNumberInRaw(
    ...
    if (raw !== undefined && num !== undefined) {
      ...
      switch (true) {
        ...
        case /ss ss/.test(raw):
          ...
          raw = raw.replace(
            /ss ss/,
            Encoder42.convertByteAsHex(num / 256) +
              " " +
              Encoder42.convertByteAsHex(num % 256)
          );
          break;
        ...
        case /([\dA-F])l/.test(raw):
          ...
          if (match) {
            raw = raw.replace(
              /([\dA-F])l/,
              Encoder42.convertByteAsHex(
                parseInt("0x" + match[1] + "0") + 1 + num
              )
            );
          }
          break;
        ...
        case /(\d)r/.test(raw):
          ...
          if (match) {
            raw = raw.replace(
              /(\d)r/,
              Encoder42.convertByteAsHex(parseInt(match[1]) * 16 + num)
            );
          }
          break;
  ...
  private static arr_rpnMap = [
    ...
    { key: "10↑X", value: [{ regex: /10↑X/, raw: "57" }] },
    { key: "4STK", value: [{ regex: /4STK/, raw: "A7 E2" }] },
    ...
    { key: "ANUM", value: [{ regex: /ANUM/, raw: "A6 42" }] },
    { key: "AOFF", value: [{ regex: /AOFF/, raw: "8B" }] },
    { key: "AON", value: [{ regex: /AON/, raw: "8C" }] },
    { key: "APPEND", value: [{ regex: /APPEND/, raw: "A7 E9" }] },
    {
      key: "ARCL",
      value: [
    ...
    { key: "ASINH", value: [{ regex: /ASINH/, raw: "A0 64" }] },
    {
      ...
      value: [
        {
          regex: /ASSIGN (".{1,14}") TO (0[1-9]|1[0-8])/,
          raw: "Fn C0 aa",
          params: "nam,key-1",
        },
      ],
    ...
    {
      key: "CLP",
      value: [{ regex: /CLP (".{1,14}")/, raw: "Fn F0", params: "lbl" }],
    },
    ...
    { key: "DEPTH", value: [{ regex: /DEPTH/, raw: "A7 E6" }] },
    ...
    { key: "DROP", value: [{ regex: /DROP/, raw: "A2 71" }] },
    {
      key: "DROPN",
      value: [
        { regex: /DROPN ([1-8])/, raw: "F2 A1 rr", params: "reg" },
      ],
    },
    {
      key: "DSE",
    ...
    { key: "DUP", value: [{ regex: /DUP/, raw: "A7 E7" }] },
    {
      key: "DUPN",
      value: [
        { regex: /DUPN ([1-8])/, raw: "F2 A2 rr", params: "reg" },
      ],
    },
    ...
    { key: "ERRMSG", value: [{ regex: /ERRMSG/, raw: "A7 F6" }] },
    { key: "ERRNO", value: [{ regex: /ERRNO/, raw: "A7 F7" }] },
    { key: "EXITALL", value: [{ regex: /EXITALL/, raw: "A2 6C" }] },
    { key: "EXPF", value: [{ regex: /EXPF/, raw: "A0 A0" }] },
    { key: "EXTEND", value: [{ regex: /EXTEND/, raw: "A7 EA" }] },
    ...
    { key: "FMA", value: [{ regex: /FMA/, raw: "A7 DA" }] },
    ...
    { key: "GROW", value: [{ regex: /GROW/, raw: "A6 E3" }] },
    {
      ...
      value: [
        ...
        {
          regex: /GTO (1[5-9]|[2-9][0-9]|[a-eA-J])/,
          raw: "D0 00 nn",
          params: "lblno",
        }, // 15-99,A-J,a-e
    ...
    { key: "J-", value: [{ regex: /J-/, raw: "A6 D5" }] },
    {
      ...
      value: [
        {
          regex: /KEY ([1-9]) GTO IND ST ([XYZLT])/,
          raw: "F3 E3 kk Ft",
          params: "key,stk",
        }, // key:1-9
        {
          regex: /KEY ([1-9]) GTO IND (".{1,14}")/,
          raw: "Fn CB kk",
          params: "key,nam",
        },
        {
          regex: /KEY ([1-9]) GTO IND (\d{2})/,
          raw: "F3 E3 kk 8r",
          params: "key,reg",
        },
        {
          regex: /KEY ([1-9]) GTO (".{1,14}")/,
          raw: "Fn C3 kk",
          params: "key,lbl",
        },
        {
          regex: /KEY ([1-9]) GTO (0[0-9]|[1-9][0-9]|[a-eA-J])/,
          raw: "F3 E3 kk rr",
          params: "key,lblno",
        }, // { regex: /KEY `key` GTO sl/, raw: 'F3 E3 kk rr' },
        {
          regex: /KEY ([1-9]) XEQ IND ST ([XYZLT])/,
          raw: "F3 E2 kk Ft",
          params: "key,stk",
        },
        {
          regex: /KEY ([1-9]) XEQ IND (".{1,14}")/,
          raw: "Fn CA kk",
          params: "key,nam",
        },
        {
          regex: /KEY ([1-9]) XEQ IND (\d{2})/,
          raw: "F3 E2 kk 8r",
          params: "key,reg",
        },
        {
          regex: /KEY ([1-9]) XEQ (".{1,14}")/,
          raw: "Fn C2 kk",
          params: "key,lbl",
        },
        {
          regex: /KEY ([1-9]) XEQ (0[0-9]|[1-9][0-9]|[a-eA-J])/,
          raw: "F3 E2 kk rr",
          params: "key,lblno",
    ...
    { key: "L4STK", value: [{ regex: /L4STK/, raw: "A7 E3" }] },
    { key: "LASTX", value: [{ regex: /LASTX/, raw: "76" }] },
    {
      ...
      value: [
        ...
        {
          regex: /LBL (1[5-9]|[2-9][0-9]|[a-eA-J])/,
          raw: "CF nn",
          params: "lblno",
        }, // 15-99,A-J,a-e
    ...
    {
      key: "MVAR",
      value: [{ regex: /MVAR (".{1,14}")/, raw: "Fn 90", params: "nam" }],
    },
    ...
    { key: "NSTK", value: [{ regex: /NSTK/, raw: "A7 E4" }] },
    { key: "NULL", value: [{ regex: /NULL/, raw: "00" }] },
    { key: "N→C", value: [{ regex: /N→C/, raw: "A7 F2" }] },
    { key: "N→S", value: [{ regex: /N→S/, raw: "A7 F0" }] },
    ...
    { key: "PGMMENU", value: [{ regex: /PGMMENU/, raw: "A7 E8" }] },
    {
      key: "PGMSLV",
      value: [
    ...
    { key: "RCLFLAG", value: [{ regex: /RCLFLAG/, raw: "A6 60" }] },
    ...
    { key: "REV", value: [{ regex: /REV/, raw: "A7 ED" }] },
    ...
    { key: "R↑", value: [{ regex: /R↑/, raw: "74" }] },
    {
      key: "R↑N",
      value: [
        { regex: /R↑N ([1-8])/, raw: "F2 A6 rr", params: "reg" },
      ],
    },
    { key: "R↓", value: [{ regex: /R↓/, raw: "75" }] },
    {
      key: "R↓N",
      value: [
        { regex: /R↓N ([1-8])/, raw: "F2 A5 rr", params: "reg" },
      ],
    },
    {
      key: "SCI",
    ...
    { key: "STOFLAG", value: [{ regex: /STOFLAG/, raw: "A6 6D" }] },
    ...
    { key: "SUBSTR", value: [{ regex: /SUBSTR/, raw: "A7 EB" }] },
    { key: "SUM", value: [{ regex: /SUM/, raw: "A0 A5" }] },
    { key: "S→N", value: [{ regex: /S→N/, raw: "A7 EF" }] },
    ...
    { key: "UVEC", value: [{ regex: /UVEC/, raw: "A6 CD" }] },
    {
      key: "UNPICK",
      value: [
        { regex: /UNPICK ([1-8])/, raw: "F2 A4 rr", params: "reg" },
      ],
    },
    {
      key: "VARMENU",
    ...
    { key: "X<>F", value: [{ regex: /X<>F/, raw: "A6 6E" }] },
    ...
    {
      key: "⊢`str`",
      value: [{ regex: /⊢(".{14}")/, raw: "Fn 7F", params: "str" }],
    }, // max. length 14
  ];
