  ...
  private static arr_rawMap = [
    ...
    },
    {
      ...
      value: [
        ...
        { regex: /A7 E2/, len: 2, rpn: "4STK" },
        { regex: /A7 E3/, len: 2, rpn: "L4STK" },
        { regex: /A7 E4/, len: 2, rpn: "NSTK" },
        { regex: /A7 E5/, len: 2, rpn: "LNSTK" },
        { regex: /A7 E6/, len: 2, rpn: "DEPTH" },
        { regex: /A7 E7/, len: 2, rpn: "DUP" },
        { regex: /A7 E8/, len: 2, rpn: "PGMMENU" },
        { regex: /A7 E9/, len: 2, rpn: "APPEND" },
        { regex: /A7 EA/, len: 2, rpn: "EXTEND" },
        { regex: /A7 EB/, len: 2, rpn: "SUBSTR" },
        { regex: /A7 EC/, len: 2, rpn: "LENGTH" },
        { regex: /A7 ED/, len: 2, rpn: "REV" },
        { regex: /A7 EE/, len: 2, rpn: "POS" },
        { regex: /A7 EF/, len: 2, rpn: "S→N" },
        { regex: /A7 F0/, len: 2, rpn: "N→S" },
        { regex: /A7 F1/, len: 2, rpn: "C→N" },
        { regex: /A7 F2/, len: 2, rpn: "N→C" },
        { regex: /A7 F3/, len: 2, rpn: "LIST?" },
        { regex: /A7 F4/, len: 2, rpn: "NEWLIST" },
        { regex: /A7 F5/, len: 2, rpn: "NEWSTR" },
        { regex: /A7 F6/, len: 2, rpn: "ERRMSG" },
        { regex: /A7 F7/, len: 2, rpn: "ERRNO" },
        {
...

    {
      ...
      value: [
        ...
        //{ regex: /F([1-9A-F]) A1/, len: 2, rpn: "DROPN `nam`", params: "naml-1" },
        {
          regex: /F([1-9A-F]) A8/,
          len: 2,
          rpn: "SF IND `nam`",
